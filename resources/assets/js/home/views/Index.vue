...
<script>
import RightColumn from './../components/index/RightColumn';
import LeftColumn from './../components/index/LeftColumn';
import LeftColumnBot from './../components/index/LeftColumnBot';
