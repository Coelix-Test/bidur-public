<template>
    <div class="edit-post-header-wrapper">
        <div class="inputs-row">
            <input type="text" class="main-post-title" name="title" :value="title" maxlength="150" @input="$emit('updateTitle', $event.target.value)" placeholder="Add Title to the Post" required>
        </div>
        ...
        <div class="inputs-row w-100 d-flex">
            ...
            <div class="ico-input author-input d-inline-flex align-items-center">
                ...
                <input type="text" class="theme-input-text" name="author" maxlength="20" :value="author" @input="$emit('updateAuthor', $event.target.value)" placeholder="Add author">
            </div>
        </div>
